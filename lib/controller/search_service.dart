...
class SearchService extends GeneralServices {
  ...
  Future<APIResponse<List<Book>>> searchBooksByName(
    ...
    try {
      Response response = await _dio.get("product_search/searchBookByName", queryParameters: {
        "name": name,
        "pageNo": pageNo,
        "pageSize": pageSize
      });
    ...
    try {
      Response response = await _dio.get("product_search/searchBookByCategory", queryParameters: {
    ...
    try {
      Response response = await _dio.get("product_search/searchBookByISBN", queryParameters: {
        "isbn": isbn,
        "pageNo": pageNo,
        "pageSize": pageSize
      });
    ...
    try {
      Response response = await _dio.get("product_search/searchBookByLanguage", queryParameters: {
        "language": language,
        "pageNo": pageNo,
        "pageSize": pageSize
      });
    ...
    try {
      Response response = await _dio.get("product_search/searchBookByPriceRange", queryParameters: {
        "from": from,
        "to":to,
        "pageNo": pageNo,
        "pageSize": pageSize
